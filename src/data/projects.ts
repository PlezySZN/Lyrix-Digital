...
export const projectStructure: ProjectStructure[] = [
  ...
  },
  {
    ...
    liveUrl: 'https://lyrixfilms.com/',
    images: [
      '/Lyrixfilms_hero.png',
      '/Lyrixfilms_portfolio.png',
      '/Lyrixfilms_shop.png',
      '/Lirixfilms_Form.png',
    ],
  },
  ...
  },
  {
    ...
    liveUrl: 'https://lyrixdigital.com/en/',
    liveUrlEs: 'https://lyrixdigital.com/es/',
    images: [
      '/Lyrixdigital_Hero.png',
      '/Lyrixdigital_Services.png',
      '/Lyrixdigital_Portfolio.png',
      '/Lyrixdigital_Process.png',
      '/Lyrixdigital_Review.png',
      '/Lyrixdigital_FAQ.png',
      '/Lyrixdigital_Form.png',
      '/Lyrixdigital_Feature.png',
      '/Lyrixdigital_Last_CTA.png',
    ],
  },
  {
    id: '#005',
