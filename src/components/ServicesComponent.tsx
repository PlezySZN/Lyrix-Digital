  ...
  const modules = [
    {
      ...
      specs: [
        ...
        { label: 'SCORE', value: t('specs.module1.lighthouse') },
        { label: 'SEO', value: t('specs.module1.seo') },
        { label: 'LANGUAGE', value: t('specs.module1.i18n') },
        { label: 'ACCESS', value: t('specs.module1.a11y') },
      ],
    ...
    },
    {
      ...
      specs: [
        ...
        { label: 'GBP', value: t('specs.module3.gbp') },
        { label: 'ADS', value: t('specs.module3.ads') },
        { label: 'GSC', value: t('specs.module3.gsc') },
        { label: 'BING', value: t('specs.module3.bing') },
      ],
